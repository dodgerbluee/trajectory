...
import { HiChevronDown, HiChevronUp, HiUser } from 'react-icons/hi';
            ...
            <div className="settings-expandable">
              ...
              >
                <div className="settings-expandable-title">
                  <HiUser className="settings-expandable-icon" />
    ...
    <div className="page-container">
      ...
      <Card>
        <Tabs
          tabs={tabs}
          activeTab={activeTab}
          onTabChange={(tabId) => setActiveTab(tabId as 'general' | 'user')}
        />
      </Card>
    </div>
  );
