 ...
 *   - calling AuthContext.checkAuth() to refresh hasSelfChild and
 *     selfRecordPromptDismissed,
 *   - calling a caller-supplied children reload (HomePage and FamilyPage
 *     each have their own children list to refresh),
